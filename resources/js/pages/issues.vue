	...
	<t-modal ref="modal" class="curdmodel">
		  ...
		  <div class="dropdown inline-block relative">
		    <svg class="fill-current h-4 w-4 inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
		   	...
		   	<span>{{ singleissue.status }}</span>
		    <ul class="dropdown-menu absolute hidden text-gray-700 pt-1">
		      	<li>
		      		<a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" @click="statusupdate('Backlog')" href="#">Backlog</a>
		      		<a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" @click="statusupdate('Picket')" href="#">Picket</a>
		      		<a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" @click="statusupdate('Done')" href="#">Done</a>
		      	</li>
		    </ul>
		  </div>
		</h2>
